  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="pt-24 pb-12 space-y-24">
        ...
        {/* Gallery Section - Commented out as component doesn't exist */}
        ...
        {/* Scroll Collage Section - Commented out as component doesn't exist */}
        {/* <div className="border-t border-white/10 pt-12">
        ...
        {/* Store Section - Commented out as component doesn't exist */}
        {/* <div className="border-t border-white/10 pt-12">
        ...
        {/* Partners Section - Commented out as component doesn't exist */}
        {/* <div className="border-t border-white/10 pt-12">
        ...
        {/* Track Split Section - Commented out as component doesn't exist */}
        {/* <div className="border-t border-white/10 pt-12">
        ...
        {/* Helmet Hall Section - Commented out as component doesn't exist */}
        {/* <div className="border-t border-white/10 pt-12">
          <h2 className="text-2xl font-mono text-center mb-8 text-gray-500">6. Helmet Hall Section (Unused)</h2>
          <div className="relative isolate">
            <HelmetHall />
          </div>
        </div> */}

        {/* Testimonial Section - Commented out as component doesn't exist */}
        {/* <div className="border-t border-white/10 pt-12">
          <h2 className="text-2xl font-mono text-center mb-8 text-gray-500">
            7. Testimonial Section (Superseded by BikeShowcase)
          </h2>
          <div className="relative isolate">
            <TestimonialSection />
          </div>
